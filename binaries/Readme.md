...
![Architecture of how tools like Photon use the Prisma binaries via the Prisma SDK](./prisma-framework.png) -> Whoever has the original shoud update this to include the introspection binary. 
