...
The examples API can be implemented via a simple JSON file that contains all the infos for all examples. The CLI fetches this file and can therefore print all dynamic elements required in a success message. Here is a sample structure for the JSON file (see the full file [below](#example-data-json)):
