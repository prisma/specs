...
1. Display all available examples (screens: SQLite 4, MySQL 5, PostgreSQL 5)
1. Success screens (screens: SQLite 5, MySQL 6, PostgreSQL 6)

## Idea

### Endpoint to fetch info for examples
...
Alternatively, it could be implemented via a GraphQL API.