...
<Terminal>
  ...
  <Box marginLeft={2} flexDirection="column">
    <Text>The <Text bold>hello-world</Text> directory was created.</Text>
    <Text>It contains your Prisma setup and the starter code for a GraphQL server.</Text>
  ...
  >
    <Box marginLeft={2} width={100} flexDirection="column">
      <Text>
        Start Prisma's development mode:
      </Text>
