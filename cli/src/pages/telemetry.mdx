...
<Terminal>
  ...
  <Box marginLeft={2} flexDirection="column" marginBottom={1}>
    <Text bold>Please help us improve Prisma 2 by submitting an error report.</Text>
    <Text bold>Error reports never contain personal or other sensitive information.</Text>
  ...
  >
    <Box width={100}>
      <Box width={10}>
         <Color cyan><Text bold>{figures.pointer} Yes</Text></Color>
      </Box>
    ...
    <Box width={100}>
      ...
      <Color dim>Save response for future errors</Color>
      <Box flexGrow={1}></Box>
    </Box>
    <Box width={100}>
      <Box width={10} marginLeft={2}>
  ...
  <Box marginLeft={2} flexDirection="column" marginBottom={1}>
    <Text bold>Thank you for helping us making Prisma 2 more stable! 🙏</Text>
  </Box>
</Terminal>
